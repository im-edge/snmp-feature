...
class ScenarioDefinition implements JsonSerialization
{
    ...
    public static function fromSerialization($any): ScenarioDefinition
    {
        ...
        return new ScenarioDefinition(
            ...
            dbTable: ($any->dbTable ?? null)
                ...
                : null,
            measurement: ($any->measurement ?? null)
                ? MeasurementDefinition::fromSerialization($any->measurement)
                : null
        );
    }
    ...
    public function jsonSerialize(): stdClass
    {
        ...
        if ($this->snmpTableIndexes) {
            $object['snmpTableIndexes'] = $this->snmpTableIndexes;
        }
        if ($this->measurement) {
